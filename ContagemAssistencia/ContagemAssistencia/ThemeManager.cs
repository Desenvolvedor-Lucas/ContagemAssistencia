...
using System.Text;
using Xamarin.Forms;
using ContagemAssistencia.ThemeResources;
                    ...
                    case Themes.Default:
                        {
                            ...
                            mergedDictionaries.Add(new PadraoTheme());
                            break;
                        }
                    case Themes.Light:
                        {
                            mergedDictionaries.Add(new LimaoTheme());
                            break;
                        }
                    case Themes.Dark:
                        {
                            mergedDictionaries.Add(new NoiteTheme());
                            break;
                        }
                    case Themes.Blue:
                        {
                            mergedDictionaries.Add(new AquaticoTheme());
                            break;
                        }
                    case Themes.Orange:
                        {
                            mergedDictionaries.Add(new FogoTheme());
                            break;
                        }
                    default:
                        mergedDictionaries.Add(new PadraoTheme());
